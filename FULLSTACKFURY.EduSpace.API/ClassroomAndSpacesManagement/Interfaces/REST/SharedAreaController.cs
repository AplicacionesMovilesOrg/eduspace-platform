...
using FULLSTACKFURY.EduSpace.API.ClassroomAndSpacesManagement.Interfaces.REST.Transform.SharedArea;
    ...
    ISharedAreaCommandService sharedAreaCommandService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetSharedAreaById(string id)
    {
    ...
    public async Task<IActionResult> CreateSharedArea([FromBody] CreateSharedAreaResource resource)
    {
        ...
        if (sharedAreaResource is null) return BadRequest();
    ...
    public async Task<IActionResult> UpdateSharedArea([FromRoute] string id,
        [FromBody] UpdateSharedAreaResource resource)
    {
        try
        {
    ...
    public async Task<IActionResult> DeleteSharedArea([FromRoute] string id)
    {
        try
        {
