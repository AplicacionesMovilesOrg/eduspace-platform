...
using FULLSTACKFURY.EduSpace.API.ClassroomAndSpacesManagement.Interfaces.REST.Transform.Classroom;
    ...
    IClassroomCommandService classroomCommandService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetClassroomById(string id)
    {
    ...
    public async Task<IActionResult> CreateClassroom(string teacherId, [FromBody] CreateClassroomResource resource)
    {
    ...
    public async Task<IActionResult> UpdateClassroom([FromRoute] string id, [FromBody] UpdateClassroomResource resource)
    {
        try
        {
